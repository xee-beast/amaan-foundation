...
return [
    'main' => [
        ...
        [
            ...
            'children' => [
                ...
                ['label' => 'Child & Youth Program', 'url' => $placeholder],
        ...
        [
            ...
            'children' => [
                ...
                ['label' => 'Monthly Giving', 'url' => $placeholder],
                ['label' => 'Sponsor Her Journey', 'url' => $placeholder],
                ['label' => 'Gaza Evacuees Support', 'url' => $placeholder],
                ['label' => 'Fundraise For Us', 'url' => $placeholder],
                ['label' => 'Ways to Donate', 'url' => $placeholder],
                ['label' => 'Non-Monetary Donation', 'url' => $placeholder],
            ],
        ],
        [
            'label' => 'Dhul Hijjah',
    ...
    'languages' => [
        ...
        ['code' => 'fr', 'label' => 'FR', 'url' => $placeholder],
        ['code' => 'ur', 'label' => 'UR', 'url' => $placeholder],
        ['code' => 'so', 'label' => 'SO', 'url' => $placeholder],
        ['code' => 'ar', 'label' => 'AR', 'url' => $placeholder],
    ],
    'ctas' => [
        'donate' => ['label' => 'DONATE', 'url' => $placeholder],
        'apply' => ['label' => 'Apply For Help', 'url' => $placeholder],
    ],
];
